...
if __name__ == '__main__':
    # python main.py --img_size 256 --mode syn --checkpoint_dir expr/checkpoint/SyRa --out_dir expr/result --data test/art_sociology_building_test --resume_iter 100000 --val_batch_size 1
    
    torch.cuda.empty_cache()
    # Clear all tensors tracked by PyTorch on CUDA
    for obj in list(globals().values()):
        if isinstance(obj, torch.Tensor) and obj.is_cuda:
            del obj

    # Optional: Synchronize to ensure GPU cleanup
